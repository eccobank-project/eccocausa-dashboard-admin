...
import ContactsTable from "@/shared/components/contacts-table";
...
export const DashboardView = () => {
  const { stats } = useLoaderData() as DashboardLoaderData;
          ...
          {(resolvedStats) => (
            <StatsGrid
              stats={[
                {
                  title: "Connections",
                  value: resolvedStats.connections,
                  change: {
                    value: "+12%",
                    trend: "up",
                  },
                ...
                {
                  title: "Contacts",
                  value: resolvedStats.contacts,
                  change: {
                    value: "+42%",
                    trend: "up",
                  },
                  icon: (
                    <svg fill="currentColor" height={19} width={18} xmlns="http://www.w3.org/2000/svg">
                ...
                {
                  title: "Referrals",
                  value: resolvedStats.referrals,
                  change: {
                    value: "-17%",
                    trend: "down",
                  },
                  icon: (
                    <svg fill="currentColor" height={21} width={21} xmlns="http://www.w3.org/2000/svg">
