  ...
  return (
    <div className="mx-auto w-full max-w-md">
      ...
      <div className="mb-8 text-center">
        ...
        <p className="text-lg text-muted-foreground">Tu cuenta no tiene permisos para acceder a Eccocausa</p>
      </div>
      ...
      <div className="rounded-2xl border border-border bg-card p-8 shadow-lg">
        ...
        {/* Error Message */}
        <div className="mb-8 text-center">
          <h2 className="mb-4 font-semibold text-foreground text-xl">No puedes acceder en este momento</h2>
          <div className="mb-6 rounded-lg border border-border bg-muted p-4">
            <p className="text-muted-foreground text-sm">
              ...
              <br />
              Tu cuenta de Google no está registrada en nuestro sistema como un usuario autorizado para acceder a
              Eccocausa.
            </p>
          </div>
          <p className="text-muted-foreground leading-relaxed">
            Solo los usuarios previamente registrados por el administrador pueden acceder a la plataforma. Si necesitas
            acceso, por favor contacta al soporte técnico.
          </p>
        </div>
          ...
          <Button
            ...
            onClick={() => {
              window.location.href =
                "mailto:soporte@eccocausa.com?subject=Solicitud de acceso a Eccocausa&body=Hola, necesito acceso a la plataforma Eccocausa. Mi email de Google es: ";
            }}
            variant="outline"
          >
            Contactar soporte
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3 text-muted-foreground text-sm">
              ...
              <div>
                ...
                <br />
                Envía un email al administrador del sistema incluyendo tu dirección de correo de Google.
              </div>
            </div>
            <div className="flex items-start gap-3 text-muted-foreground text-sm">
              <svg className="mt-0.5 h-4 w-4 flex-shrink-0 text-primary" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="mt-8 text-center">
        <p className="text-muted-foreground text-sm">
          ¿Problemas técnicos?{" "}
          <a className="font-medium text-primary hover:text-primary/80" href="mailto:soporte@eccocausa.com">
            Reportar problema
          </a>
        </p>
      </div>
