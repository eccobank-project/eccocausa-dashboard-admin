-- Funciones RPC para manejar geometrías PostGIS en sectores
...
-- Función RPC para actualizar sectores con geometría
...
-- Función RPC para obtener un sector con geometría
...
-- Función RPC para obtener todos los sectores con geometría
